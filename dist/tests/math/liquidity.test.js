...
describe('Liquidity', () => {
    describe('.getOppositeAmount', () => {
        test('should return correct opposite Liquidity Amount', () => {
            const oppositeAmount = math_1.Liquidity.getOppositeAmount({
                amountIn: '1',
                reserveIn: '1000',
                reserveOut: '10',
                decimalsIn: 10,
            ...
            expect(oppositeAmount).toEqual(new bignumber_js_1.default('1'));
        });
        test('should return zero when amount is zero', () => {
            ...
            expect(oppositeAmount).toEqual(new bignumber_js_1.default('0'));
        });
        ...
        test('should throw when the input is invalid', () => {
            const getOppositeAmount = () => math_1.Liquidity.getOppositeAmount({
    ...
    describe('.getMinimalAmountIn', () => {
        test('should return the correct minimal amount in', () => {
            const result = math_1.Liquidity.getMinimalAmountIn({
                reserve: '4736077088416',
                reserveOpposite: '866090525036542790',
                decimals: 8,
                decimalsOpposite: 12,
            });
            expect(result).toEqual(new bignumber_js_1.default('0.0001'));
        });
        test('should return the correct minimal amount in', () => {
            const result = math_1.Liquidity.getMinimalAmountIn({
            ...
            expect(result).toEqual(new bignumber_js_1.default('0.001828708674'));
        });
    });
    describe('.getPosition', () => {
        test('should return the correct Liquidity Position amount', () => {
            const result = math_1.Liquidity.getPosition({
                amount0: '0.00004466',
                decimals0: 8,
            ...
            expect(result).toEqual(new bignumber_js_1.default('1744859'));
        });
        test('should return the correct Liquidity Position amount for empty reserves', () => {
            ...
            expect(result).toEqual(new bignumber_js_1.default('62245'));
        });
        test('should throw if the amount0 is invalid', () => {
            expect(() => math_1.Liquidity.getPosition({
                amount0: '1.79',
                decimals0: 8,
                amount1: '2',
                decimals1: 8,
    ...
    describe('.getShareOfPool', () => {
        test('should return the correct Liquidity Position share of a pool (case 1)', () => {
            const result = math_1.Liquidity.getShareOfPool({
                amount0: '0.00004466',
                decimals0: 8,
                amount1: '0.000719793445',
                decimals1: 12,
            ...
            expect(result).toEqual(new bignumber_js_1.default('0.00000000305122681622'));
        });
        test('should return the correct Liquidity Position share of a pool (case 2)', () => {
            ...
            expect(result).toEqual(new bignumber_js_1.default('0.5'));
        });
        test('should return the correct Liquidity Position share of a pool for empty reserves', () => {
            ...
            expect(result).toEqual(new bignumber_js_1.default('1'));
        });
    });
    describe('.getUserPositionValue', () => {
        test('should return correct user position value', () => {
            const result = math_1.Liquidity.getUserPositionValue({
                price0: '1',
                price1: '1',
                decimals0: 8,
                decimals1: 8,
            ...
            expect(result).toEqual(new bignumber_js_1.default('0.000005'));
        });
    });
    describe('.getTokenBalances', () => {
        test('should return the correct token balances (case 1)', () => {
            const result = math_1.Liquidity.getTokenBalances({
                decimals0: 8,
                decimals1: 8,
            ...
            expect(result).toEqual({
                balance0: new bignumber_js_1.default('5'),
                balance1: new bignumber_js_1.default('15'),
            });
        });
        test('should return the correct token balances (case 2)', () => {
            ...
            expect(result).toEqual({
                balance0: new bignumber_js_1.default('5.000279'),
                balance1: new bignumber_js_1.default('15.000837'),
            });
        });
    });
});
